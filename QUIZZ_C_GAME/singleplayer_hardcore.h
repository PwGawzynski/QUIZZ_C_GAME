#pragma once
/**
 * \brief Funkcja potrzebna do obs³ugi trybu hardcore w grze jednoosobowej.
 *
 ...
 */
void singleplayer_hardcore(ALLEGRO_TIMER** timer, ALLEGRO_DISPLAY** display,
	...
	while (cp_head->next)
	{
		...
		{	
			al_draw_text(*font, al_map_rgb(255,46,0), *resolution_x/2, 361,
				ALLEGRO_ALIGN_CENTER, "ODPOWIED NIEPOPRAWNA");
			al_flip_display();
			al_rest(1);
